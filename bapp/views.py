...
from bapp.forms import UserAddForm 
...
def addblog(request):
    if request.method=='POST':
        blog=Bloglist(Author_name=request.POST["Author_name"],Publish_date=request.POST["Publish_date"],Blog_title=request.POST["Blog_title"],Blog_caption=request.POST["Blog_caption"],Blog_category=request.POST["Blog_cateogry"])
